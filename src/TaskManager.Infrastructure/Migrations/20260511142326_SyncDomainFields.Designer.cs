...
namespace TaskManager.Infrastructure.Migrations
{
    ...
    [Migration("20260511142326_SyncDomainFields")]
    partial class SyncDomainFields
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("TaskManager.Domain.Entities.Project", b =>
                {
                    ...
                    b.HasIndex("WorkspaceId", "Status", "IsArchived");

                    b.ToTable("projects", (string)null);
                });

            modelBuilder.Entity("TaskManager.Domain.Entities.ProjectNote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
