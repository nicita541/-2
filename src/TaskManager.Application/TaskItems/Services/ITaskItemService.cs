...
public interface ITaskItemService
{
    ...
    Task<Result<PagedResult<TaskItemResponse>>> GetByColumnAsync(Guid boardColumnId, Guid? parentTaskItemId, int page, int pageSize, CancellationToken cancellationToken);
}
